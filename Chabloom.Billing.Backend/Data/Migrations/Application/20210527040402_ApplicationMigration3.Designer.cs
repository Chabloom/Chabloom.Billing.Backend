...
namespace Chabloom.Billing.Backend.Data.Migrations.Application
{
    ...
    [Migration("20210527040402_ApplicationMigration3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.Account", b =>
                {
                    ...
                    b.HasAlternateKey("TenantId", "ReferenceId");
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.Auth.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.Auth.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.MultiTenant.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.MultiTenant.TenantAddress", b =>
                {
                    b.Property<string>("Address")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.UserAccount", b =>
                {
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.Account", b =>
                {
                    b.HasOne("Chabloom.Billing.Backend.Models.MultiTenant.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Chabloom.Billing.Backend.Models.UserAccount", b =>
                {
                    ...
                    b.HasOne("Chabloom.Billing.Backend.Models.Auth.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Chabloom.Billing.Backend.Models.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Chabloom.Billing.Backend.Models.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
